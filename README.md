...
### Red Teamer · Penetration Tester · Security Researcher

*I break things professionally so others don't have to learn the hard way.*
...
|---------|-------------|-------|
| [**KAIJU Playbooks**](https://github.com/imxde-code) | Incident response playbooks for malware outbreaks, ransomware, APT, DDoS, and more | Markdown |
| [**scantodo**](https://github.com/imxde-code/scantodo) | CLI tool to scan codebases for TODO/FIXME/HACK comments — used in CI pipelines | TypeScript |
...
![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=imxde-code&theme=dark&hide_border=true)
...
*Open to red team roles, penetration testing contracts, and security research collaborations.*

**Let's connect →** [LinkedIn](https://linkedin.com) · [Email](mailto:imad@example.com)
